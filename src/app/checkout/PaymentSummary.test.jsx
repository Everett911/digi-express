...
describe("PaymentSummary component", () => {
  ...
  it("displays the correct details", async () => {
    ...
    expect(
      screen.getByTestId("payment-summary-money-delivery"),
    ).toHaveTextContent("$4.99");

    expect(
      screen.getByTestId("payment-summary-money-total-before-tax"),
    ).toHaveTextContent("$47.74");

    expect(
      screen.getByTestId("payment-summary-money-estimated-tax"),
    ).toHaveTextContent("$4.77");

    expect(
      screen.getByTestId("payment-summary-money-order-total"),
